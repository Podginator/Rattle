...
class SimpleNode extends interpreter.BaseASTNode implements Node {
  ...
  protected Rattle parser;

  public SimpleNode(int i) {
    id = i;
  }

  public SimpleNode(Rattle p, int i) {
    this(i);
    parser = p;
  }
  ...
  public Object jjtAccept(RattleVisitor visitor, Object data)
{
  ...
  /** Accept the visitor. **/
  public Object childrenAccept(RattleVisitor visitor, Object data)
{
    if (children != null) {
  ...
  public String toString() {
    return RattleTreeConstants.jjtNodeName[id];
  }
...
/* JavaCC - OriginalChecksum=4d807bcaefc43820d7b59fa62f59052b (do not edit this line) */
